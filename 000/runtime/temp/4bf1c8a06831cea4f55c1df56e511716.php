<?php /*a:3:{s:77:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\goods\editgoods.html";i:1545026984;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1550818501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <a href="<?php echo url('index'); ?>" class="btn btn-info">返回列表</a>
    </div>
    <div class="panel-body">
        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail1" required placeholder="名称"  value="<?php echo htmlentities($oldData['gname']); ?>" name="gname">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="cid">
                        <?php if(is_array($cateDate) || $cateDate instanceof \think\Collection || $cateDate instanceof \think\Paginator): $i = 0; $__LIST__ = $cateDate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['cid']==$oldData['cid']): ?>
                            <option selected value="<?php echo htmlentities($vo['cid']); ?>"><?php echo htmlentities($vo['cname']); ?></option>
                            <?php else: ?>
            ...
            <div class="form-group">
                <label for="inputEmail6" class="col-sm-2 control-label">快递费</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail6" required value="<?php echo htmlentities($oldData['ed']); ?>" placeholder="" name="ed">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">介绍phone</label>
                <div class="col-sm-10">
                    <textarea name="gcontent" id="editor" cols="90" rows="5"><?php echo htmlentities($oldData['gcontent']); ?></textarea>
                </div>
            </div>
            <!--gpccontent-->
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">介绍pc</label>
                <div class="col-sm-10">
                    <textarea name="gpccontent" id="editor1" cols="90" rows="5"><?php echo htmlentities($oldData['gpccontent']); ?></textarea>
                </div>
            </div>
            <div class="form-group">
