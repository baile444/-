<?php /*a:3:{s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\smess\index.html";i:1545035930;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1550818501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tbody>
            <?php if(is_array($smessdata) || $smessdata instanceof \think\Collection || $smessdata instanceof \think\Paginator): $i = 0; $__LIST__ = $smessdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                <td><?php echo htmlentities($vo['smid']); ?></td>
                <td><?php echo htmlentities($vo['phone']); ?></td>
                <td><?php echo htmlentities($vo['create_time']); ?></td>
                <td><?php echo htmlentities($vo['cid']); ?></td>
                <td><?php if($vo['content']): ?><?php echo htmlentities($vo['content']); else: ?>无<?php endif; ?></td>
                <td>
                    <textarea name="beiwang" smid="<?php echo htmlentities($vo['smid']); ?>" id="beiwang" cols="30" rows="3"><?php echo htmlentities($vo['beiwang']); ?></textarea>
                </td>
                <td>
                    <a href="javascript:;" class="btn btn-danger" urls="<?php echo url('del',['id'=>$vo['smid']]); ?>" data-toggle="modal" data-target="#myModal" onclick="attrcid()">删除</a>
                </td>
            </tr>
...
<script>
    ...
    oinputs.blur(function () {
        ...
        if (t!=text){
            $.post("<?php echo url('ajaxEditBeiwang'); ?>",{smid:id,beiwang:text,type:1},function (res) {
                if (res==1){
