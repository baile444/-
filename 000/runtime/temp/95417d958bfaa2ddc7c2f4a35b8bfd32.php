<?php /*a:3:{s:76:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\shops\editwork.html";i:1545030164;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1547545117;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">服务商业务编辑</h3>
    </div>
    <div class="panel-body">
        <a href="<?php echo url('work',['sid'=>$sid]); ?>" class="btn btn-info">返回列表</a>
    </div>
    <div class="panel-body">
        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="公司名称" name="wname" value="<?php echo htmlentities($oldData['wname']); ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">业务简介phone</label>
                <div class="col-sm-10">
                    <textarea name="wcontent" id="editor" cols="90" rows="5"><?php echo htmlentities($oldData['wcontent']); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">业务简介pc</label>
                <div class="col-sm-10">
                    <textarea name="wpccontent" id="editor1" cols="90" rows="5"><?php echo htmlentities($oldData['wpccontent']); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">上传图片(220*180)</label>
                <div class="col-sm-10" id="dispathed">
                    <input type="file"  name="file_upload" id="file_upload" />
                    <div class="images">
                        <input type="hidden" value="<?php echo htmlentities($oldData['wpic']); ?>" name="wpic" pathname="work">
                        <img src="http://image.qyfw24.com/<?php echo htmlentities($oldData['wpic']); ?>">
