<?php /*a:3:{s:76:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\goods\addlevel.html";i:1545271396;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1545208385;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="panel-body">
        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail1" required placeholder="名称"  name="lname">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-sm-2 control-label">价格</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail1" required placeholder="价格"  name="lprice">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-sm-2 control-label">积分</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail1" required placeholder="积分"  name="fen">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-sm-2 control-label">返余额</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail1" required placeholder="返余额"  name="getmoney">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-sm-2 control-label">库存</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail1" required placeholder="库存"  name="inventory">
                </div>
            </div>
            <div class="form-group">
