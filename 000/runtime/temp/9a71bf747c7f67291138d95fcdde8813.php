<?php /*a:3:{s:78:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\wechatmess\index.html";i:1534844632;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1545296189;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <a href="<?php echo url('addwechatmess'); ?>" class="btn btn-info">新增消息</a>
    </div>
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tbody>
            <?php if(is_array($messData) || $messData instanceof \think\Collection || $messData instanceof \think\Paginator): $i = 0; $__LIST__ = $messData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                <td><?php echo htmlentities($vo['id']); ?></td>
                <td><?php echo htmlentities($vo['sta']); ?></td>
                <td><?php echo htmlentities($vo['mess']); ?></td>
                <td>
                    <a href="<?php echo url('admin/wechatmess/editwechatmess',['id'=>$vo['id']]); ?>" class="btn btn-primary">编辑</a>
                    <a href="javascript:;" class="btn btn-danger" urls="<?php echo url('admin/wechatmess/delwechatmess',['id'=>$vo['id']]); ?>" data-toggle="modal" data-target="#myModal">删除</a>
                </td>
            </tr>
