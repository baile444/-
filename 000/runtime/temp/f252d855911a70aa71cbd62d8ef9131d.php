<?php /*a:3:{s:77:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\goods\editlevel.html";i:1545271485;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1545208385;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">规格编辑</h3>
    </div>
    <div class="panel-body">
        <a href="<?php echo url('level',['gid'=>app('request')->param('gid'),'page'=>app('request')->param('page')]); ?>" class="btn btn-info">返回列表</a>
    </div>
    <div class="panel-body">
        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
            <div class="form-group">
                <label for="inputEmail1" class="col-sm-2 control-label">规格名称</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail1" required placeholder="名称" value="<?php echo htmlentities($oldData['lname']); ?>"  name="lname">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-sm-2 control-label">价格</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail1" required placeholder="价格" value="<?php echo htmlentities($oldData['lprice']); ?>"  name="lprice">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-sm-2 control-label">积分</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail1" required placeholder="积分" value="<?php echo htmlentities($oldData['fen']); ?>"  name="fen">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-sm-2 control-label">返利</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail1" required placeholder="积分" value="<?php echo htmlentities($oldData['getmoney']); ?>"  name="getmoney">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-sm-2 control-label">库存</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail1" required placeholder="库存" value="<?php echo htmlentities($oldData['inventory']); ?>"  name="inventory">
                </div>
            </div>
            <div class="form-group">
