<?php /*a:3:{s:76:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\cate\recommend.html";i:1545210329;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1547447756;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <a href="<?php echo url('addrecommend',['cid'=>app('request')->param('cid')]); ?>" class="btn btn-info">新增</a>
        <a href="<?php echo url('admin/cate/index'); ?>" class="btn btn-info">返回</a>
    </div>
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tbody>
            <?php if(is_array($reData) || $reData instanceof \think\Collection || $reData instanceof \think\Paginator): $i = 0; $__LIST__ = $reData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                <td><?php echo htmlentities($vo['rid']); ?></td>
                <td><?php echo htmlentities($vo['content']); ?></td>
                <td><?php if($vo['pic']): ?><img src="http://image.qyfw24.com/<?php echo htmlentities($vo['pic']); ?>" width="300" alt=""><?php else: ?>未上传<?php endif; ?></td>
                <td><?php echo htmlentities($vo['urls']); ?></td>
                <td><input type="text" id="<?php echo htmlentities($vo['rid']); ?>" name="sort" value="<?php echo htmlentities($vo['rsort']); ?>"></td>
                <td>
                    <a href="<?php echo url('editrecommend',['rid'=>$vo['rid'],'cid'=>app('request')->param('cid')]); ?>" class="btn btn-primary">编辑</a>
                    <a href="javascript:;" class="btn btn-danger" urls="<?php echo url('delrecommend',['id'=>$vo['rid'],'cid'=>app('request')->param('cid')]); ?>" data-toggle="modal" data-target="#myModal">删除</a>
                </td>
            </tr>
...
<script>
    ...
    oinputs.blur(function () {
        ...
        if (id&&sort>=0&&sort!=t){
            $.post("<?php echo url('ajaxReEditSort'); ?>",{id:id,rsort:sort},function (res) {
                if (res.valid==1){
                    This.val(sort);
                    alert(res.msg);
                    location.reload();
