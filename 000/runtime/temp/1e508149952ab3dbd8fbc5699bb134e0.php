<?php /*a:3:{s:76:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\category\index.html";i:1543224092;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1550818501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <a href="<?php echo url('admin/category/addindex'); ?>" class="btn btn-info">新增分类</a>
    </div>
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><?php echo htmlentities($vo['clevel']); ?></td>
                <td><?php echo htmlentities($vo['cintro']); ?></td>
                <td><img src="http://image.qyfw24.com/<?php echo htmlentities($vo['cpic']); ?>" style="background: black;" alt=""></td>
                <td><img src="http://image.qyfw24.com/<?php echo htmlentities($vo['npic']); ?>" style="background: black;width: 300px" alt=""></td>
                <td><img src="http://image.qyfw24.com/<?php echo htmlentities($vo['mpic']); ?>" style="background: black;max-width: 100px;" alt=""></td>
                <td><input type="text" name="sort" id="<?php echo htmlentities($vo['cid']); ?>" value="<?php echo htmlentities($vo['sort']); ?>"></td>
                <td>
                    <a href="<?php echo url('editindex',['cid'=>$vo['cid']]); ?>" class="btn btn-primary">编辑</a>
                    <a href="javascript:;" class="btn btn-danger" urls="<?php echo url('delcategory',['id'=>$vo['cid']]); ?>" data-toggle="modal" data-target="#myModal" onclick="attrcid()">删除</a>
                    <br>
                    <br>
                    <a href="<?php echo url('admin/cateban/index',['cid'=>$vo['cid']]); ?>" class="btn btn-info">轮播图</a>
                    <br>
                    <br>
                    <a href="<?php echo url('admin/allmess/index',['cid'=>$vo['cid']]); ?>" class="btn btn-info">首页表单</a>
                    <br>
                    <br>
                    <a href="<?php echo url('admin/shopfrom/index',['sid'=>$vo['cid']]); ?>" class="btn btn-instagram">详情表单</a>
                    <br>
                    <br>
                    <a href="<?php echo url('admin/shops/work',['sid'=>$vo['cid']]); ?>" class="btn btn-soundcloud">业务</a>
                </td>
            </tr>
