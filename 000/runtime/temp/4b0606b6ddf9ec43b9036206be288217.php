<?php /*a:3:{s:76:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\user\moneylist.html";i:1548236306;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1547545117;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">余额流水列表</h3>
    </div>
    <div class="panel-body">
        <a href="javascript:;" onclick="window.history.go(-1)" class="btn btn-info">返回</a>
    </div>
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tr>
                <td><?php echo htmlentities($vo['can_id']); ?></td>
                <td><?php echo htmlentities($vo['can_content']); ?></td>
                <td><?php echo htmlentities($vo['create_time']); ?></td>
                <td><?php echo htmlentities($vo['can_money']); ?></td>
                <td><?php if($vo['can_orid']): ?><?php echo htmlentities($vo['order']['order_id']); else: ?>人工操作<?php endif; ?></td>
            </tr>
