<?php /*a:3:{s:76:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\messages\index.html";i:1551063635;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1550818501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tbody>
            <?php if(is_array($mess) || $mess instanceof \think\Collection || $mess instanceof \think\Paginator): $i = 0; $__LIST__ = $mess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td>
                    <a href="javascript:;" class="btn btn-danger" urls="<?php echo url('del',['id'=>$vo['id'],'page'=>app('request')->param('page')]); ?>" data-toggle="modal" data-target="#myModal" onclick="attrcid()">删除</a>
                </td>
            </tr>
    ...
    <div class="text-center"><?php echo $mess; ?></div>
</div>
