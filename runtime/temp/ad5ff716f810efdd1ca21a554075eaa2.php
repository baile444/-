<?php /*a:3:{s:86:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\wechatmess\addwechatmess.html";i:1545370459;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1545296189;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="panel-body">
        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">消息标识</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="消息标识" value="" name="sta">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">消息内容</label>
                <div class="col-sm-10">
                    <textarea name="mess" id="" cols="50" rows="10"></textarea>
                </div>
            </div>
            <div class="form-group">
