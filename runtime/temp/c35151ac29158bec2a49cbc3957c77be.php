<?php /*a:3:{s:78:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\firendship\index.html";i:1539589625;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1550818501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><img src="/uploads/<?php echo htmlentities($vo['pic']); ?>" style="background: black;" alt=""></td>
                <td><?php echo htmlentities($vo['urls']); ?></td>
                <td><input type="text" name="sort" id="<?php echo htmlentities($vo['id']); ?>" value="<?php echo htmlentities($vo['sort']); ?>"></td>
                <td>
                    <a href="<?php echo url('edit',['id'=>$vo['id']]); ?>" class="btn btn-primary">编辑</a>
                    <a href="javascript:;" class="btn btn-danger" urls="<?php echo url('del',['id'=>$vo['id']]); ?>" data-toggle="modal" data-target="#myModal" onclick="attrcid()">删除</a>
                </td>
            </tr>
