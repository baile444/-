<?php /*a:3:{s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\order\index.html";i:1548237761;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1550818501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body" style="overflow: scroll">
        <table class="table table-hover">
            ...
            <tr>
                <td><?php echo htmlentities($vo['orid']); ?></td>
                <td><?php echo htmlentities($vo['transaction_id']); ?></td>
                <td><?php echo htmlentities($vo['order_id']); ?></td>
                <td><?php echo htmlentities($vo['create_time']); ?></td>
                <td><?php echo htmlentities($vo['hadpay']); ?></td>
                <td>
                    <?php echo json_decode($vo['address_before'],256)['province']; ?><?php echo json_decode($vo['address_before'],256)['city']; ?><?php echo json_decode($vo['address_before'],256)['area']; ?><?php echo htmlentities($vo['address_after']); ?>
                </td>
                <td><?php echo htmlentities($vo['phone']); ?></td>
                <td>
                    <?php if(is_array($vo['ordermess']) || $vo['ordermess'] instanceof \think\Collection || $vo['ordermess'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['ordermess'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?>
                        名称：<?php echo htmlentities($sub['gname']); ?> <br>
                        规格：<?php echo htmlentities($sub['lname']); ?> <br>
                        数量：<?php echo htmlentities($sub['counts']); ?> <br>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </td>
                <td>
                    <?php if($vo['fapiao']): ?>
                    <?php echo htmlentities($vo['fapiao']['fpcompany']); ?> <br>
                    <?php echo htmlentities($vo['fapiao']['fpnum']); ?> <br>
                    <?php echo htmlentities($vo['fapiao']['fpaddress']); ?> <br>
                    <?php echo htmlentities($vo['fapiao']['fpphone']); ?> <br>
                    <?php echo htmlentities($vo['fapiao']['fpbank']); ?> <br>
                    <?php echo htmlentities($vo['fapiao']['fpbanknum']); ?> <br>
                    <?php else: ?>
                    无
                    <?php endif; ?>
                </td>
                <td><input type="text" id="<?php echo htmlentities($vo['orid']); ?>" name="sort" value="<?php echo htmlentities($vo['code']); ?>"></td>
                <td>
                    <a href="<?php echo url('admin/order/suorder',['orid'=>$vo['orid']]); ?>" class="btn btn-instagram">确认发货</a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
...
<script>
  ...
  oinputs.blur(function () {
    ...
    if (id&&sort>=0&&sort!=t){
      $.post("<?php echo url('ajaxEditSort'); ?>",{id:id,code:sort},function (res) {
        if (res > 0){
          This.val(sort);
          location.reload();
        }else {
