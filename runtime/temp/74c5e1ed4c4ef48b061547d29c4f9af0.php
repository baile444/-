<?php /*a:1:{s:76:"D:\000phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\login\index.html";i:1551853980;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form id="form" method="POST" >
    <div class="bg">
        <div class="table_login">
            ...
            <div class="font">花草煎管理系统</div>
            <div class="kuang">
                <input type="text" name="userName" id="name" placeholder="用户名" class="input" required/>
            </div>
            <div class="kuang">
                <input type="password" name="userPwd" placeholder="密 码" class="input" required />
            </div>
            <div class="kuang">
