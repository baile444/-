<?php /*a:3:{s:72:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\cate\index.html";i:1545209672;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1547447756;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <a href="<?php echo url('add'); ?>" class="btn btn-info">新增</a>
    </div>
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td>顶级</td>
                <td>
                    <a href="<?php echo url('recommend',['cid'=>0]); ?>" class="btn btn-soundcloud">广告列表</a>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="sort" id="<?php echo htmlentities($vo['cid']); ?>" value="<?php echo htmlentities($vo['csort']); ?>"></td>
                <td>
                    <a href="<?php echo url('recommend',['cid'=>$vo['cid']]); ?>" class="btn btn-soundcloud">广告列表</a>
                    <a href="<?php echo url('edit',['cid'=>$vo['cid']]); ?>" class="btn btn-primary">编辑</a>
                    <a href="javascript:;" class="btn btn-danger" urls="<?php echo url('del',['id'=>$vo['cid']]); ?>" data-toggle="modal" data-target="#myModal" onclick="attrcid()">删除</a>
                </td>
            </tr>
