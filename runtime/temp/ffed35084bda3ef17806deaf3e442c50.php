<?php /*a:3:{s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\goods\index.html";i:1551085417;s:75:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\master.html";i:1540867117;s:73:"D:\phpstudy\PHPTutorial\WWW\tp5.1\application\admin\view\public\menu.html";i:1550818501;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <a href="<?php echo url('admin/goods/addgoods'); ?>" class="btn btn-info">新增商品</a>
    </div>
    <div class="panel-body">
    ...
    <div class="panel-body" style="overflow: scroll">
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><?php if($vo['ed']==0): ?>免<?php else: ?><?php echo htmlentities($vo['ed']); endif; ?></td>
                <td><input type="text" id="<?php echo htmlentities($vo['gid']); ?>" name="sort" value="<?php echo htmlentities($vo['gsort']); ?>"></td>
                <td>
                    <?php if($vo['re']): ?>
                    <a href="<?php echo url('admin/goods/rececommend',['gid'=>$vo['gid'],'page'=>app('request')->param('page'),'re'=>0]); ?>" class="btn btn-default">取消推荐</a>
                    <?php else: ?>
                    <a href="<?php echo url('admin/goods/rececommend',['gid'=>$vo['gid'],'page'=>app('request')->param('page'),'re'=>1]); ?>" class="btn btn-danger">设置推荐</a>
                    <?php endif; ?>
                    <a href="<?php echo url('admin/goods/pic',['gid'=>$vo['gid'],'page'=>app('request')->param('page')]); ?>" class="btn btn-instagram">商品图片</a>
                    <a href="<?php echo url('admin/goods/level',['gid'=>$vo['gid'],'page'=>app('request')->param('page')]); ?>" class="btn btn-info">规格库存</a>
                    <a href="<?php echo url('admin/goods/editgoods',['gid'=>$vo['gid'],'page'=>app('request')->param('page')]); ?>" class="btn btn-primary">编辑</a>
                    <?php if($vo['gsta']): ?>
                    <a href="<?php echo url('admin/goods/rececommend',['gid'=>$vo['gid'],'page'=>app('request')->param('page'),'gsta'=>0]); ?>" class="btn btn-info">上架中</a>
                    <?php else: ?>
                    <a href="<?php echo url('admin/goods/rececommend',['gid'=>$vo['gid'],'page'=>app('request')->param('page'),'gsta'=>1]); ?>" class="btn btn-danger">下架中</a>
                    <?php endif; ?>
                    <a href="javascript:;" class="btn btn-danger" urls="<?php echo url('admin/goods/delgoods',['id'=>$vo['gid'],'page'=>app('request')->param('page')]); ?>" data-toggle="modal" data-target="#myModal" onclick="attrcid()">删除</a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>
        <div class="text-center"><?php echo $goodsData; ?></div>
    </div>
</div>
<!-- Modal -->
...
<script>
  ...
  oinputs.blur(function () {
    ...
    if (id&&sort>=0&&sort!=t){
      $.post("<?php echo url('ajaxEditSort'); ?>",{id:id,gsort:sort},function (res) {
        if (res.valid==1){
          This.val(sort);
          alert(res.msg);
          location.reload();
